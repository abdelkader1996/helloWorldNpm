import MgrAudioParam from 'webaudiomodules/sdk-parammgr/src/MgrAudioParam.js';
...
/** @typedef {import('webaudiomodules/sdk-parammgr/src/types.js').ParamMgrOptions} ParamMgrOptions */
/** @typedef {import('webaudiomodules/sdk-parammgr/src/types.js').ParamMgrCallFromProcessor} ParamMgrCallFromProcessor */
/** @typedef {import('webaudiomodules/sdk-parammgr/src/types.js').ParamMgrCallToProcessor} ParamMgrCallToProcessor */
/** @typedef {import('webaudiomodules/sdk-parammgr/src/types.js').ParamMgrNodeMsgIn} ParamMgrNodeMsgIn */
/** @typedef {import('webaudiomodules/sdk-parammgr/src/types.js').ParamMgrNodeMsgOut} ParamMgrNodeMsgOut */
/** @typedef {import('webaudiomodules/sdk-parammgr/src/types.js').ParamMgrNode} IParamMgrNode */

/** @type {typeof import('webaudiomodules/sdk-parammgr/src/TypedAudioWorklet.js').TypedAudioWorkletNode} */
// @ts-ignore
