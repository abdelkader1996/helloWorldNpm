...
/** @typedef {import('webaudiomodules/sdk-parammgr/src/types').ParamMgrOptions} ParamMgrProcessorOptions */
/** @typedef {import('webaudiomodules/sdk-parammgr/src/TypedAudioWorklet').AudioWorkletGlobalScope} AudioWorkletGlobalScope */
/** @typedef {import('webaudiomodules/sdk-parammgr/src/TypedAudioWorklet').TypedAudioWorkletProcessor} AudioWorkletProcessor */
/** @template M @typedef {import('webaudiomodules/sdk-parammgr/src/types').MessagePortRequest<M>} MessagePortRequest */
/** @template M @typedef {import('webaudiomodules/sdk-parammgr/src/types').MessagePortResponse<M>} MessagePortResponse */
/** @typedef {import('webaudiomodules/sdk-parammgr/src/types').ParamMgrCallFromProcessor} ParamMgrCallFromProcessor */
/** @typedef {import('webaudiomodules/sdk-parammgr/src/types').ParamMgrCallToProcessor} ParamMgrCallToProcessor */
/** @typedef {import('webaudiomodules/sdk-parammgr/src/types').ParamMgrAudioWorkletOptions} ParamMgrAudioWorkletOptions */
/** @typedef {import('webaudiomodules/sdk-parammgr/src/types').ParametersMapping} ParametersMapping */
/** @typedef {import('webaudiomodules/sdk-parammgr/src/types').WamParamMgrSDKBaseModuleScope} WamParamMgrSDKBaseModuleScope */
