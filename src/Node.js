import CompositeAudioNode from '../node_modules/@webaudiomodules/sdk-parammgr/src/CompositeAudioNode.js';
//TODO:
//import ParamMgrFactory from '../node_modules/@webaudiomodules/sdk-parammgr/src/ParamMgrFactory.js';
...
export default class TemplateWamNode extends CompositeAudioNode {
	...
	async createNodes(module) {
		...
		/** @type {import('../node_modules/@webaudiomodules/sdk-parammgr/src').ParametersMappingConfiguratorOptions<'gain' | 'delay', 'gain' | 'delay'>} */
		const optionsIn = {
	...
	async setup(module) {
		...
		this.gainNode.connect(this.feedbackNode);
